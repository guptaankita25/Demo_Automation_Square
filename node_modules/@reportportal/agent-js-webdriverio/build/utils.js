...
const getClientConfig = (options) => {
    const { endpoint, launch, project, rerun, rerunOf, skippedIssue, description, attributes, mode, debug, headers, restClientConfig, isLaunchMergeRequired, launchUuidPrint, launchUuidPrintOutput, oauth, } = options;
